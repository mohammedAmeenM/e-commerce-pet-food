    ...
    <div style={{ background: 'rgb(230, 230, 219)' }}>
      ...
      <Container>
                ...
                <Card className="shadow p-1 m-2 bg-body-tertiary rounded" style={{ width: '18rem', height: '31rem', alignItems: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                  <CardBody>
                    ...
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <Button onClick={() => decreaseQuantity(item.Id)} className='m-1'>-</Button>
                      <h6>Total: ₹{totalCartItem(item)}</h6>
                    </div>
                    <div>
                      <Button onClick={() => buyProduct(item.Id)} variant="outline-dark">Buy Product</Button>
                      <Button className='m-2' variant="outline-dark" onClick={() => removeItem(item.Id)}>Remove</Button>
                    </div>
                  </CardBody>
                </Card>
              </div>
        ...
        <div className=' p-5 ' style={{ background: 'rgb(230, 230, 219)' }}>
          <h2 className='pb-4' style={{ textAlign: 'center' }}>Total Price: {totalCartPrice}</h2>
          <div style={{ textAlign: 'center' }}>
